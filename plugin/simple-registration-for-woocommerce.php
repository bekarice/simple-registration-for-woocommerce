 ...
 *
 * @package   Simple registration for WooCommerce
 * @author    SkyVerge
 * @category  Admin
 ...
 * @since 1.0.0
 */
class Simple_Registration_WC_Loader {
	...
	const PLUGIN_NAME = 'Simple registration for WooCommerce';

	/** @var Simple_Registration_WC_Loader single instance of this plugin */
	...
	/**
	 * Simple_Registration_WC_Loader constructor.
	 *
	 * @since 1.0.0
	 */
	...
	/**
	 * Displays any admin notices added with \Simple_Registration_WC_Loader::add_admin_notice()
	 *
	 * @since 1.0.0
	 */
	...
	/**
	 * Gets the main \Simple_Registration_WC_Loader instance.
	 *
	 * Ensures only one instance can be loaded.
	 *
	 * @since 1.0.0
	 *
	 * @return \Simple_Registration_WC_Loader
	 */
...
// fire it up!
Simple_Registration_WC_Loader::instance();
